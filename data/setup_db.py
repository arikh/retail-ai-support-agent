...
def seed_plans(conn: sqlite3.Connection) -> None:
    ...
    plans = [
        ...
        (
            "PLAN-001", "SUMMER_LATAM_V2",
            "LATAM", "Brazil", "Wholesale", "Summer",
            "COMPLETED", "2024-01-15", 10, 8
        ),
        # Plan with missing materials
        (
            "PLAN-002", "FALL_EU_2024",
            "EU", "Germany", "Retail", "Fall",
            "COMPLETED", "2024-02-10", 6, 5
        ),
        # Plan in progress
        (
            "PLAN-003", "WINTER_NA_2024",
            "NA", "USA", "Wholesale", "Winter",
            "IN_PROGRESS", "2024-03-01", 8, 6
        ),
        # Plan with downstream issues
        (
            "PLAN-004", "SPRING_LATAM_2024",
            "LATAM", "Mexico", "Retail", "Spring",
            "COMPLETED", "2024-03-15", 5, 5
        ),
    ]
...
def seed_plan_materials(conn: sqlite3.Connection) -> None:
    ...
    plan_materials = [
        ...
        ("PLAN-001", "M-1009", "Summer", "NOT_PRICED",  None,            "EXPIRY_HORIZON_RULE",       None),
        ("PLAN-001", "M-1011", "Summer", "NOT_PRICED",  None,            "EXPIRY_HORIZON_RULE",       None),
        ...
        ("PLAN-002", "M-3001", "Fall",   "NOT_PRICED",  None,            "CATEGORY_CHANNEL_RULE",     None),
        ...
        ("PLAN-003", "M-1011", "Winter", "NOT_PRICED",  None,            "EXPIRY_HORIZON_RULE",       None),
        ("PLAN-003", "M-1012", "Winter", "NOT_PRICED",  None,            "ACTIVE_MATERIAL_RULE",      None),
...
def verify_database(conn: sqlite3.Connection) -> None:
    ...
    for row in cursor.fetchall():
        print(f"  {row[0]:<25} {row[1]:<6} {row[2]:<12} "
